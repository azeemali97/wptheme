    ...
    <article class="content px-3 py-5 p-md-5">
        <div class="container">
            <header class="content-header">
                <div class="meta mb-3"><span class="date"><?php the_time(  ) ?></span><span class="tag"><i class='fa fa-tag'></i> <?php the_tags() ?></span><span class="tag"><i class='fa fa-tag'></i> <?php the_category( ) ?></span><span class="comment"><a href="#comments"><i class='fa fa-comment'></i> 3 comments</a></span></div>
            </header>
